    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Chào mừng trở lại! Đây là tổng quan về hoạt động phỏng vấn của bạn.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 mb-1">Tổng phỏng vấn</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-green-600">+0.5 Điểm tăng trung bình</p>
              </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">25 phút</p>
                <p className="text-sm text-green-600">-3 phút Thời gian phỏng vấn</p>
              </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-green-600">+5% Tỷ lệ pass phỏng vấn</p>
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-sm text-gray-600 mb-6">Các tính năng thường dùng</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Link href="/avatar-interview" 
                  ...
                  <span className="text-sm font-medium text-gray-900 text-center">AI Avatar Interview</span>
                  <span className="text-xs text-gray-500 mt-1">Phỏng vấn với AI Avatar</span>
                ...
                <Link href="/practice/quiz" 
                  ...
                  <span className="text-sm font-medium text-gray-900 text-center">Xem bài cao</span>
                  <span className="text-xs text-gray-500 mt-1">Học về tất cả vấn đề kỹ thuật</span>
                  <button className="mt-3 px-4 py-2 bg-pink-600 text-white text-xs rounded-lg hover:bg-pink-700 transition-colors">
                    Xem ngay
                  </button>
                </Link>

                <Link href="/practice/eq" 
                  ...
                  <span className="text-sm font-medium text-gray-900 text-center">EQ Test</span>
                  <span className="text-xs text-gray-500 mt-1">Kiểm tra chỉ số EQ của bạn</span>
                ...
                <Link href="/jd" 
                  ...
                  <span className="text-sm font-medium text-gray-900 text-center">AI with JD</span>
                  <span className="text-xs text-gray-500 mt-1">Đánh giá kỹ năng chuyên môn</span>
          ...
          <div className="space-y-6">
            {/* Phân tích năng lực */}
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold mb-4">Phân tích năng lực</h3>
              <p className="text-sm text-gray-600 mb-6">Điểm số năng lực theo lĩnh vực kỹ năng</p>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-lg font-semibold">Phỏng vấn gần đây</h3>
              <p className="text-sm text-gray-600">Danh sách các cuộc phỏng vấn gần nhất</p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex items-center space-x-4">
                <div className="text-right">
                  <p className="text-lg font-bold text-blue-600">Đang chờ</p>
